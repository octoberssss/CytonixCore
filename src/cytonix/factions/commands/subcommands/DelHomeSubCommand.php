...
class DelHomeSubCommand extends BaseSubCommand {
    ...
    public function __construct() {
        parent::__construct("delhome", "Remove a faction home");
    }
    ...
    public function onRun(CommandSender $sender, string $aliasUsed, array $args) : void {
        ...
        if ($faction->getOwner() !== $sender->getName()) {
            $sender->sendMessage(FormatUtils::PREFIX_BAD . "You do not have permission to remove a faction home.");
            return;
        }
        $name = $args["name"];
        ...
        $faction->delHome($name);
        $sender->sendMessage(FormatUtils::PREFIX_GOOD . "Remove faction home.");
    }
